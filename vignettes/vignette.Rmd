...
For the rest of the vignette, we are going to use **ExoData** object for the three replicates. These objects are available in `r Biocexptpkg("ChIPexoQualExample")`, and can be loaded by using:
